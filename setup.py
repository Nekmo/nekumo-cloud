...
PACKAGE_NAME = 'nekumo'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/nekumo-cloud/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/nekumo-cloud'
STATUS_LEVEL = 3  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['nekumo', 'cloud', 'file', 'manager', 'player', 'media', 'center', 'video', 'audio']  # Palabras clave
